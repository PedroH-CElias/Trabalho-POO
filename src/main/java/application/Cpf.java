...
public class Cpf {
	public boolean validaCpf(long cpf) {
		...
		if (CPF.length() != 11) {
			JOptionPane.showMessageDialog(null, "Erro! Cpf com tamanho incorreto!", "ERRO", JOptionPane.ERROR_MESSAGE);
			return false;
		}
		if (CPF.equals("00000000000") || CPF.equals("11111111111") || CPF.equals("22222222222")
			...
			JOptionPane.showMessageDialog(null, "Erro! Cpf com dígitos iguais!", "ERRO", JOptionPane.ERROR_MESSAGE);
			return false;
		} else {
